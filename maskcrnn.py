...
# Default checkpoint usado en __main__ y en infer_server si no se envía ruta
DEFAULT_MODEL_WEIGHTS = "best_model (17).pth"
...
def run_inference(
    ...
    print(f"[maskcrnn.py] dispositivo: {device}")
    ...
    print(f"[maskcrnn.py] Guardado: {binary_path}, {overlay_path}")
    return result
...
def infer_with_model(
    ...
    """
    Runs Mask R-CNN v2 inference with a pre-loaded model.
